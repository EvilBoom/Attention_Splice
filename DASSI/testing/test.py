...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, help='data_species',default='hs')
    parser.add_argument('--type', type=str, help='typ', default='don')
    parser.add_argument('--test_file', type=str, help='testfile', default='../data/asp/test_hs_don_seq.txt')
    ...
    # python test.py --typ <acc,don> --test_file --data <hs,athaliana,celegans,dmelanogaster>
    ...
    modl='../models/model_all_'+ typ +'_'+ str(len(test_Seq[0])+1) + '_v2.pt'
