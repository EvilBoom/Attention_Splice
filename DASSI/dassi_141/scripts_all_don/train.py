...
for species in ['hs','athaliana','celegans','dmelanogaster']:
    file_test_seq='/media/appadmin/MY_BOOK/data/splicing/asp_data_subset/proc_' + species +'/test_' + species + '_don_seq.txt'
    file_test_label='/media/appadmin/MY_BOOK/data/splicing/asp_data_subset/proc_' + species +'/test_' + species + '_don_label.txt'
