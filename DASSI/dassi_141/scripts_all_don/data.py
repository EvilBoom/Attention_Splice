...
class Corpus(object):
    def __init__(self, path):
        ...
        self.train_label = self.tokenize(os.path.join(path, 'train_label.txt'))
        self.valid_label = self.tokenize(os.path.join(path, 'valid_label.txt'))
        self.test_label = self.tokenize(os.path.join(path, 'test_label.txt'))
