...
file_name1 ="/media/appadmin/MY_BOOK/data/splicing/splice2deep_data/proc_all/all_don_seq.txt"
file_name2 ="/media/appadmin/MY_BOOK/data/splicing/splice2deep_data/proc_all/all_don_label.txt"
...
for species in ['hs','athaliana','celegans','dmelanogaster']:
    file_test_seq='/media/appadmin/MY_BOOK/data/splicing/splice2deep_data/proc_' + species +'/test_' + species + '_don_seq.txt'
    file_test_label='/media/appadmin/MY_BOOK/data/splicing/splice2deep_data/proc_' + species +'/test_' + species + '_don_label.txt'
